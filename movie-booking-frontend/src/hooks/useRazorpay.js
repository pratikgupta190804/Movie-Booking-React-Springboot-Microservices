  ...
  const initiatePayment = useCallback(
    async ({
      ...
      try {
        ...
        console.log("Full orderData from backend:", orderData); // ← add this
        console.log("razorpayOrderId:", orderData?.razorpayOrderId);
        console.log("razorpayKeyId:", orderData?.razorpayKeyId);
